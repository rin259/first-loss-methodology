...
- License: CC BY 4.0
- Comments: 8 pages, 3 tables; accompanying v1.1.1 reproducibility artifact at https://doi.org/10.5281/zenodo.22734716
...
Upload `first-loss-v1.1.1-arxiv-source.tar.gz`. Confirm the generated preview matches `../pdf/first-loss-v1.1.1-preprint.pdf`, then stop before the final submission action unless the author has approved it.
